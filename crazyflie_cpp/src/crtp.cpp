...
crtpFullyActuatedSetpointRequest::crtpFullyActuatedSetpointRequest(
  ...
  : header(0x07, 0), type(6)
{
	...
	this->omegax = omega_float_to_fix16(rollRate);
	this->omegay = omega_float_to_fix16(pitchRate);
	this->omegaz = omega_float_to_fix16(yawRate);
}
